...
(global-set-key (kbd "H-\\") 'kill-ring-save)
(global-set-key [(hyper ?`)] 'my-yank-primary)
(global-set-key [(meta ?`)] 'my-yank-clip)
(global-set-key [(hyper insert)] 'kill-ring-save)
(global-set-key [(hyper delete)] 'my-yank-primary)
(global-set-key [(meta delete)] 'my-yank-clip)
